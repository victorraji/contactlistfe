          ...
          >
            <div>
              <b-card-text class='details-container' v-show='details'>
                ...
                <div class='phone colors'><div class="phone-container " v-for='(number,index) in contact.phone_number' :key='index'>
                  <div>{{number}}</div></div></div>
                <div class='addresstext colortext '>Address :</div>
                <div class='address colors'>{{contact.address}}</div>
                <div class='Emailtext colortext'>Email :</div>
                <div class='email colors'>{{contact.email}}</div>
              </b-card-text>
            </div>
          </b-card>
        </div>
